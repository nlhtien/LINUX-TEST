...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Kora <nlhtien2002@gmail.com>");
...
static void display_current_time(void)
{
    ...
    SSD1306_Write(true, '0' + ((t.tm_year + 1900) / 1000));
    SSD1306_Write(true, '0' + (((t.tm_year + 1900) / 100) % 10));
    SSD1306_Write(true, '0' + (((t.tm_year + 1900) / 10) % 10));
    SSD1306_Write(true, '0' + ((t.tm_year + 1900) % 10));
    SSD1306_Write(true, '-');
    SSD1306_Write(true, '0' + (((t.tm_mon + 1) / 10) % 10));
    SSD1306_Write(true, '0' + ((t.tm_mon + 1) % 10));
    SSD1306_Write(true, '-');
    SSD1306_Write(true, '0' + ((t.tm_mday / 10) % 10));
    SSD1306_Write(true, '0' + (t.tm_mday % 10));
    SSD1306_Write(true, ' ');
    SSD1306_Write(true, '0' + ((t.tm_hour / 10) % 10));
    SSD1306_Write(true, '0' + (t.tm_hour % 10));
    SSD1306_Write(true, ':');
    SSD1306_Write(true, '0' + ((t.tm_min / 10) % 10));
    SSD1306_Write(true, '0' + (t.tm_min % 10));
    SSD1306_Write(true, ':');
    SSD1306_Write(true, '0' + ((t.tm_sec / 10) % 10));
    SSD1306_Write(true, '0' + (t.tm_sec % 10));
}


//Find device - full fill the display for begin
